<template>
<uni-shadow-root class="f2-index"><canvas type="2d" class="f2-canvas" @touchstart="touchStart" @touchmove="touchMove" @touchend="touchEnd">
...
export default global['__wxComponents']['f2/index']
</script>
